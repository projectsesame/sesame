	...
	Specify("redirects can be specified on route rule", func() {
		...
		route := &gatewayapi_v1alpha2.HTTPRoute{
			...
			Spec: gatewayapi_v1alpha2.HTTPRouteSpec{
				Hostnames: []gatewayapi_v1alpha2.Hostname{"requestredirectrule.gateway.projectsesame.io"},
						...
						Filters: []gatewayapi_v1alpha2.HTTPRouteFilter{
							{
								...
								RequestRedirect: &gatewayapi_v1alpha2.HTTPRequestRedirectFilter{
									Hostname: gatewayapi.ListenerHostname("projectsesame.io"),
								},
							},
						},
		...
		assert.Equal(t, "http://projectsesame.io/basic-redirect", res.Headers.Get("Location"))
