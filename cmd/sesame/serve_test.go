...
func TestGetDAGBuilder(t *testing.T) {
	...
	t.Run("all default options", func(t *testing.T) {
		...
		got := serve.getDAGBuilder(dagBuilderConfig{rootNamespaces: []string{}, dnsLookupFamily: sesame_api_v1alpha1.AutoClusterDNSFamily})
	...
	t.Run("client cert specified", func(t *testing.T) {
		...
		got := serve.getDAGBuilder(dagBuilderConfig{rootNamespaces: []string{}, dnsLookupFamily: sesame_api_v1alpha1.AutoClusterDNSFamily, clientCert: clientCert})
		commonAssertions(t, got)
	...
	t.Run("fallback cert specified", func(t *testing.T) {
		...
		got := serve.getDAGBuilder(dagBuilderConfig{rootNamespaces: []string{}, dnsLookupFamily: sesame_api_v1alpha1.AutoClusterDNSFamily, fallbackCert: fallbackCert})
		commonAssertions(t, got)
	...
	t.Run("client and fallback certs specified", func(t *testing.T) {
		...
		got := serve.getDAGBuilder(dagBuilderConfig{rootNamespaces: []string{}, dnsLookupFamily: sesame_api_v1alpha1.AutoClusterDNSFamily, clientCert: clientCert, fallbackCert: fallbackCert})
		commonAssertions(t, got)
	...
	t.Run("request and response headers policy specified", func(t *testing.T) {
		...
		got := serve.getDAGBuilder(dagBuilderConfig{rootNamespaces: []string{}, dnsLookupFamily: sesame_api_v1alpha1.AutoClusterDNSFamily, headersPolicy: policy})
		commonAssertions(t, got)
