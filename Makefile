...
# 'sesame serve'. On MacOS this will work, but may not on other OSes. Defining
...
# Sets the string output by "sesame version" and labels on container image.
# Defaults to current tagged git version but can be overridden.
BUILD_VERSION ?= $(VERSION)

GO_BUILD_VARS = \
	github.com/projectsesame/sesame/internal/build.Version=${BUILD_VERSION} \
	github.com/projectsesame/sesame/internal/build.Sha=${BUILD_SHA} \
	github.com/projectsesame/sesame/internal/build.Branch=${BUILD_BRANCH}
...
## Loads sesame image into kind cluster specified by CLUSTERNAME (default
