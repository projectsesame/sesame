...
// SesameConfigurationSpec represents a configuration of a Sesame controller.
...
// Used for Sesame config YAML file parsing, otherwise we could use K8s types.NamespacedName.
...
// +kubebuilder:resource:scope=Namespaced,shortName=sesameconfig
