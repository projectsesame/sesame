...
const (
	// GroupName is the group name for the Sesame API
	GroupName = "projectsesame.io"
)
...
// Resource gets an Sesame GroupResource for a specified resource
...
// by third parties who import the Sesame API types.
