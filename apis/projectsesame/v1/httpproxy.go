...
type ExtensionServiceReference struct {
	...
	// If this field is not specified, the default "projectsesame.io/v1alpha1" will be used
	//
	// +optional
...
type TLS struct {
	...
	// performs client validation as Sesame will ensure client certificates
	// are passed along.
	//
	// +optional
...
type HTTPHealthCheckPolicy struct {
	...
	// If left empty (default value), the name "sesame-envoy-healthcheck"
	// will be used.
...
type HTTPProxyStatus struct {
	...
	// and vice versa.
	//
	// Sesame will leave untouched any other Conditions set in this block,
