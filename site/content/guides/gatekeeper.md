...
sesame-8596d6dbd7-9nrg2       1/1     Running     0          32m
sesame-8596d6dbd7-mmtc8       1/1     Running     0          32m
```
...
spec:
  virtualhost:
    fqdn: default.retries.projectsesame.io
  routes:
    - conditions:
        - prefix: /foo
      services:
