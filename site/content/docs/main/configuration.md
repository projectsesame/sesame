...
| `--Sesame-config-name`                                  | Name of the SesameConfiguration resource to use                       |
...
| `--leader-election-retry-period`                         | The interval which Sesame will attempt to acquire leadership lease.   |
...
_Note:_ Configuring leader election via the configuration file is deprecated, please use the `Sesame serve` command line flags instead.
...
| port                    | int    | 8000 (Sesame), 8002 (Envoy) | Port that metrics server will bind to.                                       |
...
| <nobr>--admin-port (Deprecated)</nobr> | 9001              | Deprecated: Port is now configured as a Sesame flag.                                                                                                                                                        |
