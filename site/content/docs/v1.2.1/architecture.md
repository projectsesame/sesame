...
## Diagram
Below is a high level architectural diagram of how Sesame works inside a Kubernetes cluster as well as showing the data path of a request to a backend pod.
