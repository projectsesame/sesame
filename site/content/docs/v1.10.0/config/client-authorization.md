...
Note that Sesame requires the extension to implement the "v2" version of the protocol.
...
[2]: /docs/{{< param version >}}/config/api/#projectsesame.io/v1alpha1.ExtensionService
[3]: https://www.envoyproxy.io/docs/envoy/latest/api-v2/service/auth/v2/external_auth.proto
[4]: /docs/{{< param version >}}/config/api/#projectsesame.io/v1.UpstreamValidation
[5]: /docs/{{< param version >}}/config/api/#projectsesame.io/v1.AuthorizationServer
[6]: /docs/{{< param version >}}/config/api/#projectsesame.io/v1.AuthorizationPolicy
