...
For a list of other functionality that remains to be implemented, see Contour's [area/gateway-api](https://github.com/projectsesame/sesame/labels/area%2Fgateway-api) label.
...
With Gateway API:
```bash
kubectl apply -f https://github.com/projectsesame/sesame/blob/v1.20.0-beta.1/examples/render/contour-gateway.yaml
```

Without Gateway API:
```bash
kubectl apply -f https://github.com/projectsesame/sesame/blob/v1.20.0-beta.1/examples/render/contour.yaml
```
