...
metadata:
  name: testserver
  namespace: sesame-auth
spec:
  dnsNames:
  - testserver.auth.projectsesame.io
...
metadata:
  ...
  namespace: sesame-auth
  labels:
    app.kubernetes.io/name: sesame-testserver
spec:
  selector:
    matchLabels:
      app.kubernetes.io/name: sesame-testserver
  ...
  template:
    ...
    spec:
      containers:
      - name: testserver
        image: sesame-authserver:latest
...
spec:
  ...
  - name: testserver
    port: 9443
    validation:
      subjectName: testserver.auth.projectsesame.io
      caSecret: testserver
...
[3]: https://github.com/projectsesame/sesame/issues/2459
[4]: https://www.envoyproxy.io/docs/envoy/latest/api-v2/api/v2/cluster.proto
[5]: https://github.com/projectsesame/sesame/issues/432
[6]: https://www.envoyproxy.io/docs/envoy/latest/api-v2/config/filter/http/jwt_authn/v2alpha/config.proto
[7]: https://github.com/projectsesame/sesame/issues/432#issuecomment-587963331
[8]: https://www.envoyproxy.io/docs/envoy/latest/api-v2/api/v2/core/health_check.proto#core-healthcheck-grpchealthcheck
[9]: https://github.com/projectsesame/sesame/issues/2325
[10]: https://github.com/projectsesame/sesame/pull/2642
[11]: https://github.com/projectsesame/sesame/issues/2664
