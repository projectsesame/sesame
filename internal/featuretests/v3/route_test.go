...
// projectsesame/sesame#172. Updating an object from
//
...
// sesame#250 ingress.kubernetes.io/force-ssl-redirect: "true" should apply
...
// tested in internal/sesame/route_test.go
func TestRDSIngressClassAnnotation(t *testing.T) {
	...
	i1 := &networking_v1.Ingress{
		ObjectMeta: metav1.ObjectMeta{
			...
			Namespace: "default",
			Annotations: map[string]string{
				"projectsesame.io/ingress.class": "linkerd",
			},
		},
		Spec: networking_v1.IngressSpec{
			DefaultBackend: featuretests.IngressBackend(s1),
	...
	i3 := &networking_v1.Ingress{
		ObjectMeta: metav1.ObjectMeta{
			...
			Namespace: "default",
			Annotations: map[string]string{
				"projectsesame.io/ingress.class": "sesame",
			},
		},
		Spec: networking_v1.IngressSpec{
			DefaultBackend: featuretests.IngressBackend(s1),
