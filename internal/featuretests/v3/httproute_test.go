...
func TestGateway_TLS(t *testing.T) {
	...
	c.Request(routeType).Equals(&envoy_discovery_v3.DiscoveryResponse{
		Resources: resources(t,
			envoy_v3.RouteConfiguration("https/test.projectsesame.io",
				envoy_v3.VirtualHost("test.projectsesame.io",
		...
		Resources: resources(t,
			&envoy_listener_v3.Listener{
				...
				FilterChains: appendFilterChains(
					filterchaintls("test.projectsesame.io", sec1,
						httpsFilterFor("test.projectsesame.io"),
						nil, "h2", "http/1.1"),
				),
