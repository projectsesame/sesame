...
// Test that sesame correctly recognizes the upstream-protocol.tls
// service annotation.
func TestUpstreamProtocolTLS(t *testing.T) {
	...
	s1 := fixture.NewService("kuard").
		Annotate("projectsesame.io/upstream-protocol.tls", "securebackend").
...
// Test that sesame correctly recognizes the upstream-protocol.h2c
// service annotation.
func TestUpstreamProtocolH2C(t *testing.T) {
	...
	s1 := fixture.NewService("kuard").
		Annotate("projectsesame.io/upstream-protocol.h2c", "securebackend").
		WithPorts(v1.ServicePort{Name: "securebackend", Port: 443, TargetPort: intstr.FromInt(8888)})
	rh.OnAdd(s1)
...
// Test that sesame correctly recognizes the upstream-protocol.h2
// service annotation.
func TestUpstreamProtocolH2(t *testing.T) {
	...
	s1 := fixture.NewService("kuard").
		Annotate("projectsesame.io/upstream-protocol.h2", "securebackend").
		WithPorts(v1.ServicePort{Name: "securebackend", Port: 443, TargetPort: intstr.FromInt(8888)})
	rh.OnAdd(s1)
