...
func TestClusterCircuitbreakerAnnotations(t *testing.T) {
	...
	s1 := fixture.NewService("kuard").
		Annotate("projectsesame.io/max-connections", "9000").
		Annotate("projectsesame.io/max-pending-requests", "4096").
		Annotate("projectsesame.io/max-requests", "404").
		Annotate("projectsesame.io/max-retries", "7").
		...
		Resources: resources(t,
			DefaultCluster(&envoy_cluster_v3.Cluster{
				...
				EdsClusterConfig: &envoy_cluster_v3.Cluster_EdsClusterConfig{
					EdsConfig:   envoy_v3.ConfigSource("sesame"),
	...
	s2 := fixture.NewService("kuard").
		Annotate("projectsesame.io/max-pending-requests", "9999").
		Annotate("projectsesame.io/max-requests", "1e6").
		Annotate("projectsesame.io/max-retries", "0").
		WithPorts(v1.ServicePort{Port: 8080, TargetPort: intstr.FromString("8080")})
