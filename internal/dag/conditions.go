...
func mergePathMatchConditions(conds []sesame_api_v1.MatchCondition) MatchCondition {
	prefix := ""
...
func pathMatchConditionsValid(conds []sesame_api_v1.MatchCondition) error {
	prefixCount := 0
...
func mergeHeaderMatchConditions(conds []sesame_api_v1.MatchCondition) []HeaderMatchCondition {
	var headerConditions []sesame_api_v1.HeaderMatchCondition
	for _, cond := range conds {
		if cond.Header != nil {
...
func headerMatchConditions(conditions []sesame_api_v1.HeaderMatchCondition) []HeaderMatchCondition {
...
func headerMatchConditionsValid(conditions []sesame_api_v1.MatchCondition) error {
	seenMatchConditions := map[sesame_api_v1.HeaderMatchCondition]bool{}
	...
	for _, v := range conditions {
		...
		case v.Header.Present:
			if seenMatchConditions[sesame_api_v1.HeaderMatchCondition{
				Name:       headerName,
				NotPresent: true,
			}] {
