...
import (
	...
	"github.com/projectsesame/sesame/internal/ingressclass"
	...
	tests := map[string]struct {
		...
		"insert ingressv1 explicit ingress class name": {
			obj: &networking_v1.Ingress{
				...
				Spec: networking_v1.IngressSpec{
					IngressClassName: pointer.StringPtr("sesame"),
				},
			},
			want: true,
		},
		...
		"insert ingressv1 incorrect projectsesame.io/ingress.class": {
			obj: &networking_v1.Ingress{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "incorrect",
					Namespace: "default",
					Annotations: map[string]string{
						"projectsesame.io/ingress.class": "nginx",
					},
				},
			},
			want: false,
		...
		"insert ingressv1 explicit projectsesame.io/ingress.class": {
			obj: &networking_v1.Ingress{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "explicit",
					Namespace: "default",
					Annotations: map[string]string{
						"projectsesame.io/ingress.class": ingressclass.DefaultClassName,
					},
				},
			},
			want: true,
		},
		"insert ingressv1 projectsesame.io ingress class annotation overrides kubernetes.io incorrect": {
			obj: &networking_v1.Ingress{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "override",
					Namespace: "default",
		...
		"insert ingressv1 projectsesame.io ingress class annotation overrides kubernetes.io correct": {
			obj: &networking_v1.Ingress{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "override",
					Namespace: "default",
		...
		"insert httpproxy incorrect projectsesame.io/ingress.class": {
			obj: &sesame_api_v1.HTTPProxy{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "simple",
					Namespace: "default",
		...
		"insert httpproxy explicit projectsesame.io/ingress.class": {
			obj: &sesame_api_v1.HTTPProxy{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "kuard",
					Namespace: "default",
		...
		"insert httpproxy projectsesame.io ingress class annotation overrides kubernetes.io incorrect": {
			obj: &sesame_api_v1.HTTPProxy{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "override",
					Namespace: "default",
		...
		"insert httpproxy projectsesame.io ingress class annotation overrides kubernetes.io correct": {
			obj: &sesame_api_v1.HTTPProxy{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "override",
					Namespace: "default",
		...
		"insert tls sesame_api_v1/v1.certificatedelegation": {
			obj: &sesame_api_v1.TLSCertificateDelegation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "delegate",
					Namespace: "default",
				},
		...
		"insert extension service": {
			obj: &sesame_api_v1alpha1.ExtensionService{
...
func TestKubernetesCacheRemove(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"remove httpproxy": {
			cache: cache(&sesame_api_v1.HTTPProxy{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "httpproxy",
					Namespace: "default",
				},
		...
		"remove extension service": {
			cache: cache(&sesame_api_v1alpha1.ExtensionService{
				ObjectMeta: fixture.ObjectMeta("default/extension"),
			}),
			obj: &sesame_api_v1alpha1.ExtensionService{
				ObjectMeta: fixture.ObjectMeta("default/extension"),
...
func TestServiceTriggersRebuild(t *testing.T) {
	...
	httpProxy := func(namespace, name string) *sesame_api_v1.HTTPProxy {
		return &sesame_api_v1.HTTPProxy{
			ObjectMeta: metav1.ObjectMeta{
				Name:      name,
				Namespace: namespace,
			},
	...
	tcpProxy := func(namespace, name string) *sesame_api_v1.HTTPProxy {
		return &sesame_api_v1.HTTPProxy{
			ObjectMeta: metav1.ObjectMeta{
				Name:      name,
				Namespace: namespace,
...
func TestSecretTriggersRebuild(t *testing.T) {
	...
	tlsCertificateDelegation := func(namespace, name string, targetNamespaces ...string) *sesame_api_v1.TLSCertificateDelegation {
		return &sesame_api_v1.TLSCertificateDelegation{
			ObjectMeta: metav1.ObjectMeta{
				Name:      name,
				Namespace: namespace,
			},
	...
	httpProxy := func(namespace, name, secretName string) *sesame_api_v1.HTTPProxy {
		return &sesame_api_v1.HTTPProxy{
			ObjectMeta: metav1.ObjectMeta{
				Name:      name,
				Namespace: namespace,
	...
	tests := map[string]struct {
		...
		"gateway listener references secret, triggers rebuild (core Group)": {
			...
			secret: secret("projectsesame", "tlscert"),
			want:   true,
		},
