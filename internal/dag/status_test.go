...
func TestDAGStatus(t *testing.T) {
	...
	type testcase struct {
		...
		want                map[types.NamespacedName]sesame_api_v1.DetailedCondition
	}
	...
	run := func(t *testing.T, desc string, tc testcase) {
		...
		t.Run(desc, func(t *testing.T) {
			...
			got := make(map[types.NamespacedName]sesame_api_v1.DetailedCondition)
	...
	proxyNoFQDN := &sesame_api_v1.HTTPProxy{
	...
	run(t, "root proxy does not specify FQDN", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyNoFQDN.Name, Namespace: proxyNoFQDN.Namespace}: fixture.NewValidCondition().WithGeneration(proxyNoFQDN.Generation).
				WithError(sesame_api_v1.ConditionTypeVirtualHostError, "FQDNNotSpecified", "Spec.VirtualHost.Fqdn must be specified"),
		},
	})

	// Simple Valid HTTPProxy
	proxyValidHomeService := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace:  "roots",
			Name:       "example",
			Generation: 24,
	...
	proxyMultiIncludeOneInvalid := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace:  "roots",
			Name:       "parent",
			Generation: 45,
	...
	proxyIncludeValidChild := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
	...
	proxyChildValidFoo2 := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace:  "roots",
			Name:       "validChild",
			Generation: 1,
	...
	proxyChildInvalidBadPort := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "invalidChild",
		},
	...
	run(t, "proxy has multiple includes, one is invalid", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			...
			{Name: proxyChildInvalidBadPort.Name, Namespace: proxyChildInvalidBadPort.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeServiceError, "ServicePortInvalid", `service "foo3": port must be in the range 1-65535`),
	...
	proxyTCPSharedService := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "nginx",
			Namespace: fixture.ServiceRootsNginx.Namespace,
		},
	...
	proxyDelegatedTCPTLS := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
		...
		Spec: sesame_api_v1.HTTPProxySpec{
			VirtualHost: &sesame_api_v1.VirtualHost{
				...
				TLS: &sesame_api_v1.TLS{
					SecretName: fixture.SecretProjectSesameCert.Namespace + "/" + fixture.SecretProjectSesameCert.Name,
				},
			},
			TCPProxy: &sesame_api_v1.TCPProxy{
				Services: []sesame_api_v1.Service{{
	...
	run(t, "tcpproxy with tls delegation failure", testcase{
		objs: []interface{}{
			fixture.SecretProjectSesameCert,
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyDelegatedTCPTLS.Name, Namespace: proxyDelegatedTCPTLS.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeTLSError, "DelegationNotPermitted", `Spec.VirtualHost.TLS Secret "projectsesame/default-ssl-cert" certificate delegation not permitted`),
		},
	})

	proxyDelegatedTLS := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "app-with-tls-delegation",
			Namespace: "roots",
		},
	...
	proxyPassthroughProxyNonSecure := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "kuard-tcp",
	...
	proxyMultipleIncludersSite1 := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "site1",
	...
	proxyMultipleIncludersSite2 := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "site2",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	proxyMultiIncludeChild := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "www",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	proxyInvalidNegativePortHomeService := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	run(t, "invalid port in service", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidNegativePortHomeService.Name, Namespace: proxyInvalidNegativePortHomeService.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeServiceError, "ServicePortInvalid", `service "home": port must be in the range 1-65535`),
		},
	})

	// proxyInvalidOutsideRootNamespace is invalid because it lives outside the roots namespace
	proxyInvalidOutsideRootNamespace := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "finance",
			Name:      "example",
		},
	...
	run(t, "root proxy outside of roots namespace", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidOutsideRootNamespace.Name, Namespace: proxyInvalidOutsideRootNamespace.Namespace}: fixture.NewValidCondition().
				WithGeneration(proxyInvalidNegativePortHomeService.Generation).
				WithError(sesame_api_v1.ConditionTypeRootNamespaceError, "RootProxyNotAllowedInNamespace", "root HTTPProxy cannot be defined in this namespace"),
		},
	})

	// proxyInvalidIncludeCycle is invalid because it delegates to itself, producing a cycle
	proxyInvalidIncludeCycle := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "self",
			Namespace: "roots",
		},
	...
	run(t, "proxy self-edge produces a cycle", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidIncludeCycle.Name, Namespace: proxyInvalidIncludeCycle.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeIncludeError, "RootIncludesRoot", "root httpproxy cannot include another root httpproxy"),
		},
	})

	// proxyIncludesProxyWithIncludeCycle delegates to proxy8, which is invalid because proxy8 delegates back to proxy8
	proxyIncludesProxyWithIncludeCycle := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "parent",
			Namespace: "roots",
		},
	...
	proxyIncludedChildInvalidIncludeCycle := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "child",
			Namespace: "roots",
		},
	...
	run(t, "proxy child delegates to itself, producing a cycle", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			...
			{Name: proxyIncludedChildInvalidIncludeCycle.Name, Namespace: proxyIncludedChildInvalidIncludeCycle.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeIncludeError, "IncludeCreatesCycle", "include creates an include cycle: roots/parent -> roots/child -> roots/child"),
		},
	})
	...
	proxyIncludedChildValid := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "validChild",
			Namespace: "roots",
		},
	...
	proxyNotRootIncludeRootProxy := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "invalidParent",
		},
	...
	singleNameFQDN := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	proxyInvalidServiceInvalid := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "invalidir",
		},
	...
	run(t, "proxy missing service is invalid", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidServiceInvalid.Name, Namespace: proxyInvalidServiceInvalid.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeServiceError, "ServiceUnresolvedReference", `Spec.Routes unresolved service reference: service "roots/invalid" not found`),
		},
	})

	// proxyInvalidServicePortInvalid is invalid because it references an invalid port on a service
	proxyInvalidServicePortInvalid := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "invalidir",
		},
	...
	run(t, "proxy with service missing port is invalid", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidServicePortInvalid.Name, Namespace: proxyInvalidServicePortInvalid.Namespace}: fixture.NewValidCondition().
				WithGeneration(proxyInvalidServiceInvalid.Generation).
				WithError(sesame_api_v1.ConditionTypeServiceError, "ServiceUnresolvedReference", `Spec.Routes unresolved service reference: port "9999" on service "roots/home" not matched`),
		},
	})

	proxyValidExampleCom := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "example-com",
			Namespace: "roots",
		},
	...
	proxyValidReuseExampleCom := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "other-example",
			Namespace: "roots",
		},
	...
	proxyValidReuseCaseExampleCom := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "case-example",
			Namespace: "roots",
		},
	...
	run(t, "conflicting proxies due to fqdn reuse", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyValidExampleCom.Name, Namespace: proxyValidExampleCom.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeVirtualHostError, "DuplicateVhost", `fqdn "example.com" is used in multiple HTTPProxies: roots/example-com, roots/other-example`),
	...
	run(t, "conflicting proxies due to fqdn reuse with uppercase/lowercase", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyValidExampleCom.Name, Namespace: proxyValidExampleCom.Namespace}: fixture.NewValidCondition().
				WithGeneration(proxyValidExampleCom.Generation).
				WithError(sesame_api_v1.ConditionTypeVirtualHostError, "DuplicateVhost", `fqdn "example.com" is used in multiple HTTPProxies: roots/case-example, roots/example-com`),
	...
	proxyRootIncludesRoot := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "root-blog",
			Namespace: "roots",
		},
	...
	proxyRootIncludedByRoot := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "blog",
	...
	run(t, "root proxy including another root", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyRootIncludesRoot.Name, Namespace: proxyRootIncludesRoot.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeVirtualHostError, "DuplicateVhost", `fqdn "blog.containersteve.com" is used in multiple HTTPProxies: marketing/blog, roots/root-blog`),
	...
	proxyIncludesRootDifferentFQDN := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "root-blog",
			Namespace: "roots",
		},
	...
	proxyRootIncludedByRootDiffFQDN := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "blog",
			Namespace: fixture.ServiceMarketingGreen.Namespace,
		},
	...
	proxyValidIncludeBlogMarketing := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "blog",
			Namespace: fixture.ServiceMarketingGreen.Namespace,
		},
	...
	proxyRootValidIncludesBlogMarketing := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "root-blog",
			Namespace: "roots",
		},
	...
	proxyValidWithMirror := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "www",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	proxyInvalidTwoMirrors := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "www",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "proxy with two mirrors", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidTwoMirrors.Name, Namespace: proxyInvalidTwoMirrors.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeServiceError, "OnlyOneMirror", "only one service per route may be nominated as mirror"),
		},
	})

	proxyInvalidDuplicateMatchConditionHeaders := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	run(t, "duplicate route condition headers", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidDuplicateMatchConditionHeaders.Name, Namespace: proxyInvalidDuplicateMatchConditionHeaders.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeRouteError, "HeaderMatchConditionsNotValid", "cannot specify duplicate header 'exact match' conditions in the same route"),
		},
	})

	proxyInvalidDuplicateIncludeCondtionHeaders := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	proxyValidDelegatedRoots := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "delegated",
		},
	...
	run(t, "duplicate include condition headers", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidDuplicateIncludeCondtionHeaders.Name,
				...
				WithGeneration(proxyInvalidDuplicateIncludeCondtionHeaders.Generation).WithError(sesame_api_v1.ConditionTypeRouteError, "HeaderMatchConditionsNotValid", "cannot specify duplicate header 'exact match' conditions in the same route"),
	...
	proxyInvalidRouteConditionHeaders := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	proxyInvalidMultiplePrefixes := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "www",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "proxy with two prefix conditions on route", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidMultiplePrefixes.Name, Namespace: proxyInvalidMultiplePrefixes.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeRouteError, "PathMatchConditionsNotValid", "route: more than one prefix is not allowed in a condition block"),
		},
	})

	proxyInvalidTwoPrefixesWithInclude := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "www",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	proxyValidChildTeamA := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "child",
			Namespace: "teama",
		},
	...
	run(t, "proxy with two prefix conditions orphans include", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidTwoPrefixesWithInclude.Name, Namespace: proxyInvalidTwoPrefixesWithInclude.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeIncludeError, "PathMatchConditionsNotValid", "include: more than one prefix is not allowed in a condition block"),
	...
	proxyInvalidPrefixNoSlash := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "www",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "proxy with prefix conditions on route that does not start with slash", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidPrefixNoSlash.Name, Namespace: proxyInvalidPrefixNoSlash.Namespace}: fixture.NewValidCondition().
				...
				WithError(sesame_api_v1.ConditionTypeRouteError, "PathMatchConditionsNotValid", "route: prefix conditions must start with /, api was supplied"),
		},
	})

	proxyInvalidIncludePrefixNoSlash := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "www",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "proxy with include prefix that does not start with slash", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidIncludePrefixNoSlash.Name, Namespace: proxyInvalidIncludePrefixNoSlash.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeIncludeError, "PathMatchConditionsNotValid", "include: prefix conditions must start with /, api was supplied"),
			{Name: proxyValidChildTeamA.Name, Namespace: proxyValidChildTeamA.Namespace}: fixture.NewValidCondition().
				Orphaned(),
		},
	})

	proxyInvalidTCPProxyIncludeAndService := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "simple",
			Namespace: "roots",
		},
	...
	run(t, "tcpproxy cannot specify services and include", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidTCPProxyIncludeAndService.Name, Namespace: proxyInvalidTCPProxyIncludeAndService.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTCPProxyError, "NoServicesAndInclude", "cannot specify services and include in the same httpproxy"),
		},
	})

	proxyTCPNoServiceOrInclusion := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "simple",
			Namespace: "roots",
		},
	...
	run(t, "tcpproxy empty", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyTCPNoServiceOrInclusion.Name, Namespace: proxyTCPNoServiceOrInclusion.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTCPProxyError, "NothingDefined", "either services or inclusion must be specified"),
		},
	})

	proxyTCPIncludesFoo := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "simple",
			Namespace: "roots",
		},
	...
	run(t, "tcpproxy w/ missing include", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyTCPIncludesFoo.Name, Namespace: proxyTCPIncludesFoo.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTCPProxyIncludeError, "IncludeNotFound", "include roots/foo not found"),
		},
	})

	proxyValidTCPRoot := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "foo",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "tcpproxy includes another root", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyTCPIncludesFoo.Name, Namespace: proxyTCPIncludesFoo.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTCPProxyIncludeError, "RootIncludesRoot", "root httpproxy cannot include another root httpproxy"),
			{Name: proxyValidTCPRoot.Name, Namespace: proxyValidTCPRoot.Namespace}: fixture.NewValidCondition().Valid(),
		},
	})

	proxyTCPValidChildFoo := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "foo",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	proxyInvalidConflictingIncludeConditions := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	proxyValidBlogTeamA := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "blogteama",
			Name:      "teama",
		},
	...
	proxyValidBlogTeamB := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "blogteamb",
			Name:      "teamb",
		},
	...
	run(t, "duplicate path conditions on an include", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidConflictingIncludeConditions.Name,
				...
				WithError(sesame_api_v1.ConditionTypeIncludeError, "DuplicateMatchConditions", "duplicate conditions defined on an include"),
	...
	proxyInvalidConflictHeaderConditions := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	proxyInvalidDuplicateHeaderAndPathConditions := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	proxyInvalidMissingInclude := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	run(t, "httpproxy w/ missing include", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidMissingInclude.Name, Namespace: proxyInvalidMissingInclude.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeIncludeError, "IncludeNotFound", "include roots/child not found"),
		},
	})

	proxyTCPInvalidMissingService := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
	...
	run(t, "httpproxy w/ tcpproxy w/ missing service", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyTCPInvalidMissingService.Name, Namespace: proxyTCPInvalidMissingService.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTCPProxyError, "ServiceUnresolvedReference", `Spec.TCPProxy unresolved service reference: service "roots/not-found" not found`),
		},
	})

	proxyTCPInvalidPortNotMatched := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
	...
	run(t, "httpproxy w/ tcpproxy w/ service missing port", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyTCPInvalidPortNotMatched.Name, Namespace: proxyTCPInvalidPortNotMatched.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTCPProxyError, "ServiceUnresolvedReference", `Spec.TCPProxy unresolved service reference: port "9999" on service "roots/kuard" not matched`),
		},
	})

	proxyTCPInvalidMissingTLS := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "missing-tls",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "httpproxy w/ tcpproxy missing tls", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyTCPInvalidMissingTLS.Name, Namespace: proxyTCPInvalidMissingTLS.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTCPProxyError, "TLSMustBeConfigured", "Spec.TCPProxy requires that either Spec.TLS.Passthrough or Spec.TLS.SecretName be set"),
		},
	})

	proxyInvalidMissingServiceWithTCPProxy := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
	...
	run(t, "httpproxy w/ tcpproxy missing service", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidMissingServiceWithTCPProxy.Name, Namespace: proxyInvalidMissingServiceWithTCPProxy.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeServiceError, "ServiceUnresolvedReference", `Spec.Routes unresolved service reference: service "roots/missing" not found`),
		},
	})

	proxyRoutePortNotMatchedWithTCP := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
	...
	run(t, "tcpproxy route unmatched service port", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyRoutePortNotMatchedWithTCP.Name, Namespace: proxyRoutePortNotMatchedWithTCP.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeServiceError, "ServiceUnresolvedReference", `Spec.Routes unresolved service reference: port "9999" on service "roots/kuard" not matched`),
		},
	})

	proxyTCPValidIncludeChild := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "validtcpproxy",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	proxyTCPValidIncludesChild := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "validtcpproxy",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
		Spec: sesame_api_v1.HTTPProxySpec{
			...
			TCPProxy: &sesame_api_v1.TCPProxy{
				IncludesDeprecated: &sesame_api_v1.TCPProxyInclude{
					Name:      "child",
					Namespace: fixture.ServiceRootsKuard.Namespace,
				},
			},
	...
	proxyTCPValidChild := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "child",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	// issue 2309
	proxyInvalidNoServices := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
	...
	run(t, "invalid HTTPProxy due to empty route.service", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyInvalidNoServices.Name, Namespace: proxyInvalidNoServices.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeRouteError, "NoServicesPresent", "route.services must have at least one entry"),
		},
	})

	fallbackCertificate := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	run(t, "invalid fallback certificate passed to sesame", testcase{
		fallbackCertificate: &types.NamespacedName{
			Name:      "invalid",
			Namespace: "invalid",
		},
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: fallbackCertificate.Name,
				...
				WithError(sesame_api_v1.ConditionTypeTLSError, "FallbackNotValid", `Spec.Virtualhost.TLS Secret "invalid/invalid" fallback certificate is invalid: Secret not found`),
		},
	})

	run(t, "fallback certificate requested but cert not configured in sesame", testcase{
		objs: []interface{}{fallbackCertificate, fixture.SecretRootsFallback, fixture.SecretRootsCert, fixture.ServiceRootsHome},
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: fallbackCertificate.Name,
				Namespace: fallbackCertificate.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTLSError, "FallbackNotPresent", "Spec.Virtualhost.TLS enabled fallback but the fallback Certificate Secret is not configured in Sesame configuration file"),
		},
	})

	fallbackCertificateWithClientValidationNoCA := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	run(t, "clientValidation missing CA", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: fallbackCertificateWithClientValidationNoCA.Name,
				...
				WithError(sesame_api_v1.ConditionTypeTLSError, "ClientValidationInvalid", "Spec.VirtualHost.TLS client validation is invalid: CA Secret must be specified"),
		},
	})

	fallbackCertificateWithClientValidation := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: "roots",
			Name:      "example",
		},
	...
	run(t, "fallback certificate requested and clientValidation also configured", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: fallbackCertificateWithClientValidation.Name,
				...
				WithError(sesame_api_v1.ConditionTypeTLSError, "TLSIncompatibleFeatures", "Spec.Virtualhost.TLS fallback & client validation are incompatible"),
		},
	})

	tlsPassthroughAndValidation := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "invalid",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "passthrough and client auth are incompatible tlsPassthroughAndValidation", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: tlsPassthroughAndValidation.Name, Namespace: tlsPassthroughAndValidation.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTLSError, "TLSIncompatibleFeatures", "Spec.VirtualHost.TLS passthrough cannot be combined with tls.clientValidation"),
		},
	})

	tlsPassthroughAndSecretName := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "invalid",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "tcpproxy with TLS passthrough and secret name both specified", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: "invalid", Namespace: fixture.ServiceRootsKuard.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTLSError, "TLSConfigNotValid", "Spec.VirtualHost.TLS: both Passthrough and SecretName were specified"),
		},
	})

	tlsNoPassthroughOrSecretName := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "invalid",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "httpproxy w/ tcpproxy with neither TLS passthrough nor secret name specified", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: "invalid", Namespace: fixture.ServiceRootsKuard.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTLSError, "TLSConfigNotValid", "Spec.VirtualHost.TLS: neither Passthrough nor SecretName were specified"),
		},
	})

	emptyProxy := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "empty",
			Namespace: "roots",
		},
	...
	run(t, "proxy with no routes, includes, or tcpproxy is invalid", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: emptyProxy.Name, Namespace: emptyProxy.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeSpecError, "NothingDefined", "HTTPProxy.Spec must have at least one Route, Include, or a TCPProxy"),
		},
	})

	invalidRequestHeadersPolicyService := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
	...
	run(t, "requestHeadersPolicy, Host header invalid on Service", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: invalidRequestHeadersPolicyService.Name, Namespace: invalidRequestHeadersPolicyService.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeServiceError, "RequestHeadersPolicyInvalid", `rewriting "Host" header is not supported on request headers`),
		},
	})

	invalidResponseHeadersPolicyService := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "invalidRHPService",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
				...
				Services: []sesame_api_v1.Service{
					{
						Name: fixture.ServiceRootsKuard.Name,
						Port: 8080,
						ResponseHeadersPolicy: &sesame_api_v1.HeadersPolicy{
							Set: []sesame_api_v1.HeaderValue{{
								Name:  "Host",
								Value: "external.com",
							}},
	...
	run(t, "responseHeadersPolicy, Host header invalid on Service", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: invalidResponseHeadersPolicyService.Name, Namespace: invalidResponseHeadersPolicyService.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeServiceError, "ResponseHeadersPolicyInvalid", `rewriting "Host" header is not supported on response headers`),
		},
	})

	invalidResponseHeadersPolicyRoute := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
	...
	run(t, "responseHeadersPolicy, Host header invalid on Route", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: invalidResponseHeadersPolicyRoute.Name, Namespace: invalidResponseHeadersPolicyRoute.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeRouteError, "ResponseHeaderPolicyInvalid", `rewriting "Host" header is not supported on response headers`),
		},
	})

	duplicateCookieRewritePolicyRoute := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
		...
		Spec: sesame_api_v1.HTTPProxySpec{
			...
			Routes: []sesame_api_v1.Route{{
				...
				CookieRewritePolicies: []sesame_api_v1.CookieRewritePolicy{
					{
						Name:   "a-cookie",
	...
	run(t, "cookieRewritePolicies, duplicate cookie names on route", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: duplicateCookieRewritePolicyRoute.Name, Namespace: duplicateCookieRewritePolicyRoute.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeRouteError, "CookieRewritePoliciesInvalid", `duplicate cookie rewrite rule for cookie "a-cookie" on route cookie rewrite rules`),
		},
	})

	duplicateCookieRewritePolicyService := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
	...
	run(t, "cookieRewritePolicies, duplicate cookie names on service", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: duplicateCookieRewritePolicyService.Name, Namespace: duplicateCookieRewritePolicyService.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeRouteError, "CookieRewritePoliciesInvalid", `duplicate cookie rewrite rule for cookie "a-cookie" on service cookie rewrite rules`),
		},
	})

	emptyCookieRewritePolicyRoute := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "invalidCRPRoute",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "cookieRewritePolicies, empty cookie rewrite on route", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: emptyCookieRewritePolicyRoute.Name, Namespace: emptyCookieRewritePolicyRoute.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeRouteError, "CookieRewritePoliciesInvalid", `no attributes rewritten for cookie "a-cookie" on route cookie rewrite rules`),
		},
	})

	emptyCookieRewritePolicyService := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "invalidCRPService",
			Namespace: fixture.ServiceRootsKuard.Namespace,
		},
	...
	run(t, "cookieRewritePolicies, empty cookie rewrite on service", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: emptyCookieRewritePolicyService.Name, Namespace: emptyCookieRewritePolicyService.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeRouteError, "CookieRewritePoliciesInvalid", `no attributes rewritten for cookie "a-cookie" on service cookie rewrite rules`),
		},
	})
	...
	proxyAuthFallback := fixture.NewProxy("roots/fallback-incompat").
		WithSpec(sesame_api_v1.HTTPProxySpec{
			VirtualHost: &sesame_api_v1.VirtualHost{
				...
				Authorization: &sesame_api_v1.AuthorizationServer{
	...
	run(t, "fallback and client auth is invalid", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: proxyAuthFallback.Name, Namespace: proxyAuthFallback.Namespace}: fixture.NewValidCondition().
				WithError(sesame_api_v1.ConditionTypeTLSError, "TLSIncompatibleFeatures", "Spec.Virtualhost.TLS fallback & client authorization are incompatible"),
		},
	})

	invalidResponseTimeout := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: fixture.ServiceRootsKuard.Namespace,
	...
	run(t, "proxy with invalid response timeout value is invalid", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			...
			}: fixture.NewValidCondition().WithError(sesame_api_v1.ConditionTypeRouteError, "TimeoutPolicyNotValid",
	...
	invalidIdleTimeout := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: fixture.ServiceRootsKuard.Namespace,
			Name:      "invalid-timeouts",
		},
	...
	tlsPassthroughAndFallback := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace:  "roots",
			Name:       "example",
			Generation: 24,
	...
	run(t, "TLS with passthrough and fallback cert enabled is invalid", testcase{
		...
		want: map[types.NamespacedName]sesame_api_v1.DetailedCondition{
			{Name: tlsPassthroughAndFallback.Name, Namespace: tlsPassthroughAndFallback.Namespace}: fixture.NewValidCondition().
				...
				sesame_api_v1.ConditionTypeTLSError, "TLSIncompatibleFeatures",
				`Spec.VirtualHost.TLS: both Passthrough and enableFallbackCertificate were specified`,
			),
		},
	})
	tlsPassthrough := &sesame_api_v1.HTTPProxy{
		ObjectMeta: metav1.ObjectMeta{
			Namespace:  "roots",
			Name:       "example",
			Generation: 24,
...
func validGatewayStatusUpdate(listenerName string, kind gatewayapi_v1alpha2.Kind, attachedRoutes int) []*status.GatewayStatusUpdate {
	return []*status.GatewayStatusUpdate{
		{
			FullName: types.NamespacedName{Namespace: "projectsesame", Name: "sesame"},
...
func TestGatewayAPIHTTPRouteDAGStatus(t *testing.T) {
	...
	run := func(t *testing.T, desc string, tc testcase) {
		...
		t.Run(desc, func(t *testing.T) {
				...
				Source: KubernetesCache{
					...
					gatewayclass: &gatewayapi_v1alpha2.GatewayClass{
						...
						Spec: gatewayapi_v1alpha2.GatewayClassSpec{
							ControllerName: "projectsesame.io/sesame",
						},
			...
			ops := []cmp.Option{
				...
				cmpopts.SortSlices(func(i, j *status.RouteConditionsUpdate) bool {
			...
			&gatewayapi_v1alpha2.HTTPRoute{
				...
				Spec: gatewayapi_v1alpha2.HTTPRouteSpec{
					CommonRouteSpec: gatewayapi_v1alpha2.CommonRouteSpec{
						ParentRefs: []gatewayapi_v1alpha2.ParentRef{gatewayapi.GatewayParentRef("projectsesame", "sesame")},
					},
		...
		objs: []interface{}{
			...
			&gatewayapi_v1alpha2.HTTPRoute{
				...
				Spec: gatewayapi_v1alpha2.HTTPRouteSpec{
					...
					Rules: []gatewayapi_v1alpha2.HTTPRouteRule{{
						Matches:     gatewayapi.HTTPRouteMatch(gatewayapi_v1alpha2.PathMatchRegularExpression, "/"),
						BackendRefs: gatewayapi.HTTPBackendRef("kuard", 8080, 1),
					}},
				},
			}},
					...
					Rules: []gatewayapi_v1alpha2.HTTPRouteRule{{
						Matches: []gatewayapi_v1alpha2.HTTPRouteMatch{{
							...
							Headers: []gatewayapi_v1alpha2.HTTPHeaderMatch{
								{
									Type:  gatewayapi.HeaderMatchTypePtr(gatewayapi_v1alpha2.HeaderMatchRegularExpression), // <---- RegularExpression type not yet supported
									Name:  gatewayapi_v1alpha2.HTTPHeaderName("foo"),
									Value: "bar",
								},
							},
						}},
	...
	run(t, "Gateway references TLS cert in different namespace, with valid ReferencePolicy", testcase{
		gateway: &gatewayapi_v1alpha2.Gateway{
			...
			Spec: gatewayapi_v1alpha2.GatewaySpec{
				GatewayClassName: gatewayapi_v1alpha2.ObjectName("projectsesame.io/sesame"),
				Listeners: []gatewayapi_v1alpha2.Listener{{
					Name:     "tls",
					Port:     443,
			...
			&gatewayapi_v1alpha2.ReferencePolicy{
				...
				Spec: gatewayapi_v1alpha2.ReferencePolicySpec{
					From: []gatewayapi_v1alpha2.ReferencePolicyFrom{{
						...
						Kind:      "Gateway",
						Namespace: gatewayapi_v1alpha2.Namespace("projectsesame"),
					}},
		...
		wantRouteConditions: []*status.RouteConditionsUpdate{{
			...
			Conditions: map[gatewayapi_v1alpha2.RouteConditionType]metav1.Condition{
				status.ConditionResolvedRefs: {
					...
					Status:  sesame_api_v1.ConditionFalse,
					Reason:  string(status.ReasonDegraded),
					Message: "invalid hostname \"#projectsesame.io\": [a lowercase RFC 1123 subdomain must consist of lower case alphanumeric characters, '-' or '.', and must start and end with an alphanumeric character (e.g. 'example.com', regex used for validation is '[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*')]",
				},
				gatewayapi_v1alpha2.ConditionRouteAccepted: {
					Type:    string(gatewayapi_v1alpha2.ConditionRouteAccepted),
					Status:  sesame_api_v1.ConditionFalse,
		...
		gateway: &gatewayapi_v1alpha2.Gateway{
			...
			Spec: gatewayapi_v1alpha2.GatewaySpec{
				Listeners: []gatewayapi_v1alpha2.Listener{{
					...
					TLS: &gatewayapi_v1alpha2.GatewayTLSConfig{
						CertificateRefs: []*gatewayapi_v1alpha2.SecretObjectReference{
							gatewayapi.CertificateRef("nonexistent-secret", "projectsesame"),
						},
					},
				}},
			},
			...
			Spec: gatewayapi_v1alpha2.GatewaySpec{
				Listeners: []gatewayapi_v1alpha2.Listener{{
					...
					TLS: &gatewayapi_v1alpha2.GatewayTLSConfig{
						...
						CertificateRefs: []*gatewayapi_v1alpha2.SecretObjectReference{
							gatewayapi.CertificateRef("tlscert", "projectsesame"),
						},
					},
				}},
			},
...
func TestGatewayAPITLSRouteDAGStatus(t *testing.T) {
	...
	run := func(t *testing.T, desc string, tc testcase) {
		...
		t.Run(desc, func(t *testing.T) {
			...
			builder.Source.Insert(fixture.SecretProjectSesameCert)
		...
		Spec: gatewayapi_v1alpha2.GatewaySpec{
			Listeners: []gatewayapi_v1alpha2.Listener{{
				...
				TLS: &gatewayapi_v1alpha2.GatewayTLSConfig{
					...
					CertificateRefs: []*gatewayapi_v1alpha2.SecretObjectReference{
						gatewayapi.CertificateRef(fixture.SecretProjectSesameCert.Name, fixture.SecretProjectSesameCert.Namespace),
					},
				},
				AllowedRoutes: &gatewayapi_v1alpha2.AllowedRoutes{
					Namespaces: &gatewayapi_v1alpha2.RouteNamespaces{
			...
			objs: []interface{}{
				...
				&gatewayapi_v1alpha2.TLSRoute{
					...
					Spec: gatewayapi_v1alpha2.TLSRouteSpec{
						...
						Hostnames: []gatewayapi_v1alpha2.Hostname{"test.projectsesame.io"},
			...
			objs: []interface{}{
				...
				&gatewayapi_v1alpha2.TLSRoute{
					...
					Spec: gatewayapi_v1alpha2.TLSRouteSpec{
						...
						Hostnames: []gatewayapi_v1alpha2.Hostname{"*.*.projectsesame.io"},
						Rules: []gatewayapi_v1alpha2.TLSRouteRule{{
