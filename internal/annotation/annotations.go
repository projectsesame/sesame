...
func IsKnown(key string) bool {
	// We should know about everything with a Sesame prefix.
	if strings.HasPrefix(key, "projectsesame.io/") {
		return true
	}
...
var annotationsByKind = map[string]map[string]struct{}{
	"Ingress": {
		...
		"projectsesame.io/ingress.class":                {},
		"projectsesame.io/num-retries":                  {},
		"projectsesame.io/response-timeout":             {},
		"projectsesame.io/retry-on":                     {},
		"projectsesame.io/tls-minimum-protocol-version": {},
		"projectsesame.io/websocket-routes":             {},
	},
	"Service": {
		"projectsesame.io/max-connections":       {},
		"projectsesame.io/max-pending-requests":  {},
		"projectsesame.io/max-requests":          {},
		"projectsesame.io/max-retries":           {},
		"projectsesame.io/upstream-protocol.h2":  {},
		"projectsesame.io/upstream-protocol.h2c": {},
		"projectsesame.io/upstream-protocol.tls": {},
	},
	"HTTPProxy": {
		"kubernetes.io/ingress.class":    {},
		"projectsesame.io/ingress.class": {},
...
func ValidForKind(kind string, key string) bool {
	...
	// We should know about every kind with a Sesame annotation prefix.
	if strings.HasPrefix(key, "projectsesame.io/") {
		return false
	}
...
// SesameAnnotation checks the Object for the given annotation with the
// "projectsesame.io/" prefix.
func SesameAnnotation(o metav1.Object, key string) string {
	a := o.GetAnnotations()

	return a["projectsesame.io/"+key]
}
...
// projectsesame.io/upstream-protocol.{protocol} annotations.
...
func ParseUpstreamProtocols(m map[string]string) map[string]string {
	...
	for _, protocol := range protocols {
		ports := m[fmt.Sprintf("projectsesame.io/upstream-protocol.%s", protocol)]
...
func WebsocketRoutes(i *networking_v1.Ingress) map[string]bool {
	...
	for _, v := range strings.Split(i.Annotations["projectsesame.io/websocket-routes"], ",") {
...
// "projectsesame.io/num-retries" annotation.
func NumRetries(i *networking_v1.Ingress) uint32 {

	val := parseInt32(SesameAnnotation(i, "num-retries"))
