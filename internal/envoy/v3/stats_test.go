...
func TestStatsListeners(t *testing.T) {
	...
	run(t, "stats-and-health-over-http-single-listener", testcase{
		metrics: sesame_api_v1alpha1.MetricsConfig{Address: "127.0.0.127", Port: 8123},
		health:  sesame_api_v1alpha1.HealthConfig{Address: "127.0.0.127", Port: 8123},
		want: []*envoy_listener_v3.Listener{{
			Name:    "stats-health",
...
func TestStatsTLSSecrets(t *testing.T) {
	type testcase struct {
		metricsTLS sesame_api_v1alpha1.MetricsTLS
