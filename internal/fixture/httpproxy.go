...
type ProxyBuilder sesame_api_v1.HTTPProxy
...
func (b *ProxyBuilder) ensureVirtualHost() {
	if b.Spec.VirtualHost == nil {
		b.Spec.VirtualHost = &sesame_api_v1.VirtualHost{}
	}
}
...
func (b *ProxyBuilder) ensureTLS() {
	...
	if b.Spec.VirtualHost.TLS == nil {
		b.Spec.VirtualHost.TLS = &sesame_api_v1.TLS{}
	}
}
...
func (b *ProxyBuilder) WithSpec(spec sesame_api_v1.HTTPProxySpec) *sesame_api_v1.HTTPProxy {
	oldSpec := b.Spec
	...
	return (*sesame_api_v1.HTTPProxy)(b)
}
...
func (b *ProxyBuilder) WithAuthServer(auth sesame_api_v1.AuthorizationServer) *ProxyBuilder {
	b.ensureTLS()
