...
-----END PRIVATE KEY-----`
	// Sesame CA Cert and key
	// Generated using:
	// openssl req -x509 -new -nodes -keyout certs/CAkey.pem -sha256 -days 1825 -out certs/CAcert.pem -subj "/O=Project Sesame/CN=Sesame CA"
...
-----END PRIVATE KEY-----`
	// Sesame CA Cert and key, without a CN
	// Generated using:
	// openssl req -x509 -new -nodes -keyout certs/CAkey.pem -sha256 -days 1825 -out certs/CAcert.pem -subj "/O=Project Sesame"
