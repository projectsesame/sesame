...
func TestRouteVisit(t *testing.T) {
	tests := map[string]struct {
			...
			objs: []interface{}{
				&networking_v1.Ingress{
					ObjectMeta: metav1.ObjectMeta{
						...
						Namespace: "default",
						Annotations: map[string]string{
							"projectsesame/request-timeout": "sesame",
						},
					},
					Spec: networking_v1.IngressSpec{
						DefaultBackend: backend("kuard", 8080),
			...
			objs: []interface{}{
				&networking_v1.Ingress{
					ObjectMeta: metav1.ObjectMeta{
						...
						Namespace: "default",
						Annotations: map[string]string{
							"projectsesame.io/request-timeout": "infinity",
						},
					},
					Spec: networking_v1.IngressSpec{
						DefaultBackend: backend("kuard", 8080),
			...
			objs: []interface{}{
				&networking_v1.Ingress{
					ObjectMeta: metav1.ObjectMeta{
						...
						Namespace: "default",
						Annotations: map[string]string{
							"projectsesame.io/request-timeout": "1m30s",
						},
					},
					Spec: networking_v1.IngressSpec{
						DefaultBackend: backend("kuard", 8080),
		...
		"vhost name exceeds 60 chars": { // projectsesame/sesame#25
			objs: []interface{}{
				&networking_v1.Ingress{
					ObjectMeta: metav1.ObjectMeta{
			...
			objs: []interface{}{
				&networking_v1.Ingress{
					ObjectMeta: metav1.ObjectMeta{
						...
						Namespace: "default",
						Annotations: map[string]string{
							"projectsesame.io/retry-on": "5xx,gateway-error",
						},
					},
					Spec: networking_v1.IngressSpec{
						DefaultBackend: backend("kuard", 8080),
			...
			objs: []interface{}{
				&networking_v1.Ingress{
					ObjectMeta: metav1.ObjectMeta{
						...
						Annotations: map[string]string{
							"projectsesame.io/retry-on":    "5xx,gateway-error",
							"projectsesame.io/num-retries": "7",
						},
					},
					Spec: networking_v1.IngressSpec{
						DefaultBackend: backend("kuard", 8080),
			...
			objs: []interface{}{
				&networking_v1.Ingress{
					ObjectMeta: metav1.ObjectMeta{
						...
						Annotations: map[string]string{
							"projectsesame.io/retry-on":        "5xx,gateway-error",
							"projectsesame.io/per-try-timeout": "150ms",
						},
					},
					Spec: networking_v1.IngressSpec{
						DefaultBackend: backend("kuard", 8080),
					...
					Spec: sesame_api_v1.HTTPProxySpec{
						...
						Routes: []sesame_api_v1.Route{{
							...
							RetryPolicy: &sesame_api_v1.RetryPolicy{
								NumRetries: -1,
								RetryOn:    []sesame_api_v1.RetryOn{"5xx", "gateway-error"},
							},
						}},
					},
				},
					...
					Spec: sesame_api_v1.HTTPProxySpec{
						VirtualHost: &sesame_api_v1.VirtualHost{
							...
							CORSPolicy: &sesame_api_v1.CORSPolicy{
								AllowOrigin:  []string{"*"},
								AllowMethods: []sesame_api_v1.CORSHeaderValue{"GET, PUT, POST"},
							},
						},
						Routes: []sesame_api_v1.Route{{
							Services: []sesame_api_v1.Service{{
		...
		"httpproxy with fallback certificate - one enabled": {
			...
			want: routeConfigurations(
				envoy_v3.RouteConfiguration("ingress_http",
					envoy_v3.VirtualHost("projectsesame.io",
						&envoy_route_v3.Route{
							Match: routePrefix("/"),
							Action: &envoy_route_v3.Route_Redirect{
								Redirect: &envoy_route_v3.RedirectAction{
				...
				envoy_v3.RouteConfiguration("https/projectsesame.io",
					envoy_v3.VirtualHost("projectsesame.io",
						&envoy_route_v3.Route{
							Match: routePrefix("/"),
							Action: &envoy_route_v3.Route_Route{
