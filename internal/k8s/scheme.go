...
// NewSesameScheme returns a scheme that includes all the API types
// that Sesame supports as well as the core Kubernetes API types from
// the default scheme.
func NewSesameScheme() (*runtime.Scheme, error) {
	s := runtime.NewScheme()
	b := runtime.SchemeBuilder{
		sesame_api_v1.AddToScheme,
		sesame_api_v1alpha1.AddToScheme,
		scheme.AddToScheme,
