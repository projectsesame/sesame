...
func main() {
	...
	prDetails, _, err := client.PullRequests.Get(ctx, "projectsesame", "sesame", pr)
	if err != nil {
...
or https://github.com/projectsesame/sesame/blob/main/design/changelog.md for background.`)
